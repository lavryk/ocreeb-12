...
# EXTENSIONS
rgb_ext = RGB(pixel_pin = board.D10, num_pixels=4, hue_default=254)
midi_ext = Midi()
...
#******** Layer 1 *******
# MACROS ROW 1
UNDO_L3  = KC.TD(KC.LCMD(KC.Z), KC.TO(2))
DEL_LINE = KC.LCMD(KC.D)
SEL_ALL = KC.LCMD(KC.A)
REDO  = KC.LCMD(KC.Y)

# MACROS ROW 2
CMD_GRAVE_L2 = KC.TD(KC.GRAVE, KC.TO(1))
...
# MACROS ROW 3
ESCAPE_L1 = simple_key_sequence([KC.ESC, KC.TO(0)])
...
keyboard.keymap = [
    ...
    [
        ...
        xxxxxxx,   CLEAR,            INSPECT,       BROWSER_PROD,
